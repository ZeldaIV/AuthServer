...
deleteScope requiredArgs____ object____ =
    Object.selectionForCompositeField "deleteScope" [ Argument.required "id" requiredArgs____.id (Api.ScalarCodecs.codecs |> Api.Scalar.unwrapEncoder .codecUuid) ] object____ Basics.identity
