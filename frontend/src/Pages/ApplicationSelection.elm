    ...
    case msg of
        ...
        ClientRedirectUrisEntered index value ->
            let
                ...
                result =
                    updateArray (Array.fromList model.clientForm.redirectUris) index value
            in
        ...
        ClientPostLogoutRedirectUrisEntered index value ->
            let
                ...
                result =
                    updateArray (Array.fromList model.clientForm.postLogoutRedirectUris) index value
            in
        ...
        SelectedGrantType grantType ->
            let
                ...
                dropDownItems =
                    List.filter (\e -> not (e == grantType)) model.grantTypes

                clientItems =
                    form.allowedGrantTypes ++ [ grantType ]
            in
        ...
        DeselectedGrantType grantType ->
            let
                ...
                dropDownItems =
                    model.grantTypes ++ [ grantType ]

                clientItems =
                    List.filter (\e -> not (e == grantType)) form.allowedGrantTypes
            in
            ( { model | grantTypes = dropDownItems, clientForm = { form | allowedGrantTypes = clientItems } }, Cmd.none )
