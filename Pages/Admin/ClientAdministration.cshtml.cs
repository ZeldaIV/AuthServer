...
namespace Authserver.Pages.Admin
{
    public class ClientAdministrationModel : PageModel
    {
        ...
        [BindProperty] public List<Client> Clients { get; set; }
        ...
        {
            [Display(Name = "Client name:")] public string ClientName { get; set; }

            [Display(Name = "Redirect Uri:")] public string RedirectUri { get; set; }

            [Display(Name = "Logout redirect:")] public string PostLogoutRedirectUri { get; set; }
        }
    }
}